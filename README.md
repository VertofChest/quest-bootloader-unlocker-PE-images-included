...
The bootloader binary can be extracted with [extract_android_ota_payload](https://github.com/cyxx/extract_android_ota_payload) and then [UEFITool](https://github.com/LongSoft/UEFITool) or [imjtool](https://newandroidbook.com/tools/imjtool.html) on the `abl.img`
